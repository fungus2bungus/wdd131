...
const hikes = [
   ...
   function searchLists(list, q) {
    function searchCallback(hike) {
      //return hike.toLowerCase().includes(q);
    ...
    const filtred = list.filter(searchCallback);
    const strort = filtred.sort((a,b) => a.distance > b.distance);
    return strort
   }

   //console.log(searchLists(simpleList, "an"));
   console.log(searchLists(hikes, "al"));
   console.log(searchLists(hikes, "water"));
   console.log(searchLists(hikes, "moderate"));
   console.log(searchLists(hikes, "yellowstone"));